...
![vscode_snippetranger_1](./VSCode_Note.assets/vscode_snippetranger_1.png)

点击各项还能查看具体 snippet 有哪些功能：

![vscode_snippetsranger_2](./VSCode_Note.assets/vscode_snippetsranger_2.png)
...
![easymotion shotcut](https://camo.githubusercontent.com/f1a424266ef277a1012643abd23aa8d4b8d737f15fa4bf44d622e11a03c745eb/68747470733a2f2f662e636c6f75642e6769746875622e636f6d2f6173736574732f333739373036322f323033393335392f61386539333864362d383939662d313165332d383738392d3630303235656138333635362e676966)
...
> [!info] 
> 
> 这个插件因为出身 [Redhat](https://www.redhat.com/)，所以很自然用的是 [Eclipse](../Java/IDE/Java_IDE_Eclipse.md) 的 [LSP](../Protocols/LSP_Note.md)，即 [jdtls](../Protocols/LSP_Note.md#jdtls)。
> 也就是说在代码提示、纠错等语言服务上，与 [Eclipse](../Java/IDE/Java_IDE_Eclipse.md) 的体验是一致的。
> 
> 而因为 RedHat-Java 这个插件也是很多 Java 插件的基础，以此插件为核心构建的 Java 开发环境，可以认为是「 VSCode 版的 Eclipse」。
...
> "java.configuration.detectJdksAtStart": false,
> ```
> 这个配置，是能禁止在加载 Java 插件时，探测 Jdk；这货经常是提示要你安装最新的 [JDK](../Java/Java_Note.md#java_jdk)，即便你已经在 `java.configuration.runtimes` 里配了「默认」JDK 了，如果它不是它要求的那个版本，那还是会在插件激活时弹出提示，太烦了，所以得禁掉。
> 
> 只要在侧边栏中「Java Projects」选项栏中，能刷出相应的 jar 包，就跟 [Eclipse](../Java/IDE/Java_IDE_Eclipse.md) 中「Build Path」中一样，那这 JDK 的配置就是可用的。
...
>
> 此插件用的是 [NetBeans](https://netbeans.apache.org) 的 [LSP](../Protocols/LSP_Note.md)。
...
)](https://github.com/Carson-yy/vscode-mybatis) 是 [MyBatis](../Java/MyBatis_Note.md) 插件。
