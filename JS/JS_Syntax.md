...
tags:
  ...
  - grammar
  - syntax
created: 2026-07-09 21:18:04
modified: 2026-07-09 21:27:44
---
...
## <span id="jsg_basic">基础语法</span>

### <span id="jsg_basic_variable">变量</span>
...
### <span id="jsg_datatype">数据类型</span>
...
#### <span id="jsg_datatype_undefined">Undefined 类型</span>
...
#### <span id="jsg_datatype_null">Null 类型</span>
...
#### <span id="jsg_datatype_boolean">Boolean 类型</span>
...
#### <span id="jsg_datatype_number">Number 类型</span>
...
##### <span id="jsg_datatype_number_range">值的范围</span>：
...
##### <span id="jsg_datatype_number_NaN">NaN</span>
...
## <span id="jsg_oop">面向对象</span>

「对象」是 JavaScript 最基本的数据类型。

对名是一种复合值，它汇聚多个值并允许我们按名字存储和获取这些值。

可以这么认为，对象是一个属性的无序集合，每个属性都有名字和值。

> [!info] 
> 
> 这种字符串到值的映射，它在其他编程语言中，有多种不同的称谓，如「散列」、「字典」或「关键数组」。

### <span id="jsg_oop_internalo">内置对象</span>

#### <span id="jsg_oop_internalo_array">数组</span>
