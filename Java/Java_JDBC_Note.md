...
C3P0 之前**曾是**[Hibernate](Hibernate/Hibernate_Note.md) 和 [Spring](Spring/Spring_Note.md) 的使用到的数据库连接池。
...
[HikariCP](https://github.com/brettwooldridge/HikariCP) 是 [Spring](Spring/Spring_Note.md) 默认使用的数据链接池。
